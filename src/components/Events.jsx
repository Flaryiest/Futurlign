    ...
    return <div className="events">
        ...
        <div className="eventsContent">
            <div className="events-section">
                ...
                <p className="events-info-text">Register for our 2025 Spring AI Coding Course at the University of Calgary. \n Classes will be held every Wednesday (March 12 - April 16), see below poster.</p>
