import "/src/style/sectionThree.css"
...
function SectionThree() {
    return <div className="sectionThree">
        <div className="sectionThreeContent">
            ...
            <div className="sectionThreeText">Awareness is the first step. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum eveniet voluptatem voluptas earum sed ratione consequatur voluptatibus! Nobis dicta, similique perspiciatis a veritatis culpa quasi accusantium veniam debitis fugit laboriosam.</div>
            </div>
        </div>
    </div>
}
